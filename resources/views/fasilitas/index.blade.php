...
@section('title', 'Fasilitas pertanian')

@section('content')
<div class="py-5 bg-light">
    <div class="container mt-5 pt-5">
        <h2 class="fw-bold text-success text-center section-title">Fasilitas</h2>
        <p class="text-muted fs-5 text-center mb-5">Fasilitas penunjang pembelajaran di Jurusan Pertanian</p>
