...
@section('title', 'Program Studi D3')

@section('content')
<div class="container py-5">
    <h1 class="text-center mb-5">Program Studi Diploma 3</h1>
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-footer bg-light">
                    <a href="{{ route('d3.show', $prodi->id) }}" class="btn btn-outline-primary">Detail Lengkap</a>
                </div>
            </div>
        </div>
        @endforeach
