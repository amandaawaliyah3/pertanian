...
class FooterSettingSeeder extends Seeder
{
    public function run()
    {
        FooterSetting::create([
            'facebook_url' => 'https://facebook.com/tptp.univ',
            'twitter_url' => 'https://twitter.com/tptp_univ',
            'instagram_url' => 'https://instagram.com/tptp.univ',
            'youtube_url' => 'https://youtube.com/c/tptpchannel',
            'address' => 'Jl. Pertanian No. 123, Kampus Universitas, Kota Samarinda, Kalimantan Timur',
            'phone' => '(0541) 1234567',
            'email' => 'info@tptp.univ.ac.id',
